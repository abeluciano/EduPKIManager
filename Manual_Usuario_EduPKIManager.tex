...
\captura{Pantalla de inicio de EduPKIManager}{Acceso al sistema EduPKIManager}
...
\captura{Formulario de inicio de sesion}{Inicio de sesion con rol administrador o usuario}
...
\captura{Barra superior por roles}{Navegacion principal del sistema}
...
\captura{Panel de Administracion}{Panel de gestion completa para administradores}
...
\captura{Formulario de emision de certificados}{Emision de certificado X.509 v3}
...
\captura{Portal de usuario final}{Vista Mi portal para usuario final}
...
\captura{Modulo de firma PDF}{Firma digital de documentos PDF}
...
\captura{Modulo de verificacion PDF}{Verificacion de firmas desprendidas y PAdES}
...
\captura{Modulo de confianza X.509}{Validacion de cadena y usos permitidos}
...
\captura{Modulo OCSP}{Consulta de estado OCSP por numero de serie}
...
\captura{Modulo TLS 1.3}{Prueba de handshake TLS 1.3}
...
\captura{Modulo de auditoria}{Registro inmutable con hash encadenado}
